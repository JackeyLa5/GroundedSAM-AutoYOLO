...
if __name__ == "__main__":
    ...
    run_suite("Grounded-SAM bbox only (Thumbnail)", THUMB_DIR, use_sam2=False)
    # 2. Grounded-SAM bbox only (Large)
    run_suite("Grounded-SAM bbox only (Large)", CAT_DIR, use_sam2=False)
    # 3. Grounded-SAM with segmentation (Thumbnails)
    run_suite("Grounded-SAM with seg (Thumbnail)", THUMB_DIR, use_sam2=True)
    # 4. Grounded-SAM with segmentation (Large)
    run_suite("Grounded-SAM with seg (Large)", CAT_DIR, use_sam2=True)
